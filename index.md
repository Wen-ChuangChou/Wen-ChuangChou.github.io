...
- **AI Multi-Agent Orchestration** — Hierarchical `smolagents` framework with Langfuse telemetry; achieves **80%** accuracy on GAIA benchmark, outperforming GPT-4's 14.4% baseline. [Details →](./ai-agent#autonomous-multi-agent-orchestration-gaia-benchmark)
